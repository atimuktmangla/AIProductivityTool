...
export function SyncPage() {
    const { state, setMode, setSelectedUsers, setSelectedProject, setScheduleOption, setScheduledTime, setPurgeLogsOnRun, setConfirmed, saveAndRun, refreshStatus, } = useSync();
