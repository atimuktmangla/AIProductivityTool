...
export function SyncPage() {
    const { state, setMode, setSelectedUsers, setSelectedProject, setScheduleOption, setPurgeLogsOnRun, setConfirmed, saveAndRun, } = useSync();
    const { status, logs, mode, selectedUsers, selectedProject, scheduleOption, purgeLogsOnRun, confirmed, isLoadingStatus, isLoadingLogs, isSaving, error, } = state;
