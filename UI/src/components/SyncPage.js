...
export function SyncPage() {
    const { state, setMode, setSelectedUsers, setSelectedProject, setScheduleOption, setScheduledTime, setPurgeLogsOnRun, setConfirmed, saveAndRun, } = useSync();
    const { status, logs, mode, selectedUsers, selectedProject, scheduleOption, scheduledTime, purgeLogsOnRun, confirmed, isLoadingStatus, isLoadingLogs, isSaving, error, } = state;
